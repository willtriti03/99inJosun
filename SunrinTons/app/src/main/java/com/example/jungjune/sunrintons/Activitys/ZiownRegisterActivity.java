 ...
 */
public class ZiownRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBackBtn= (ImageButton)findViewById(R.id.ziown_register_back);
        mCheckBtn=(ImageButton)findViewById(R.id.ziown_register_check);

        mNameEdit=(EditText)findViewById(R.id.name_ziown_register);
        mLocationEdit=(EditText)findViewById(R.id.location_ziown_register);
        mBillEdit=(EditText)findViewById(R.id.money_ziown_register);
        mInfoEdit=(EditText)findViewById(R.id.info_ziown_register);
